...
class BuildConfig:
    ...
    dir_image: str
    dir_chroot: str
    dir_publish: str             # <working>/publish — staging tree for `repo publish`
    ...
    def __init__(self) -> None:
        ...
        try:
            ...
            # COMP-02: staging tree for `repo publish` (pool/ + dists/).
            # Derived (not a [Directories] entry) — regenerated by
            # `repo index minimal`, consumed by `repo publish ssh minimal`
