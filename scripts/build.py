...
class BuildSession(AuditCommandsMixin, BuildCommandsMixin, ConfigRunCommandsMixin,
                   MirrorCommandsMixin, RepoCommandsMixin, SnapshotCommandsMixin,
                   SourceCommandsMixin, SupplyChainCommandsMixin,
